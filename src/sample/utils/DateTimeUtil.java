...
public class DateTimeUtil {
     ...
     */
    public String convertDateTimeFormat(String dtString, String inFormatString, String outFormatString){
        LocalDateTime ld = LocalDateTime.parse(dtString,
                DateTimeFormatter.ofPattern(inFormatString, Locale.US));
